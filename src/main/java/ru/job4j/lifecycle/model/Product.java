...
public class Product implements
    ...
    public void setBeanName(String name) {
        beanName = name;
        System.out.printf("2. Этот бин зарегестрирован под именем %s%n", name);
    }
    ...
    public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
        ...
        System.out.printf("2. установка BeanFactory в бин '%s'," +
                "Результат установки: '%s'%n", beanName, result);
    }
